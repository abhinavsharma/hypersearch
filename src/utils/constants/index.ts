import { ACTION_KEY, CONDITION_KEY } from './augmentations';
...
export const AWS_COGNITO_POOL_ID = IN_DEBUG_MODE ? 'us-east-2_YuInMWEfg' : 'us-east-2_7sjxHEFh3';
export const AWS_COGNITO_CLIENT_ID = IN_DEBUG_MODE ? '7bou6gv1lk6hs35ptm0ciqja77' : 's27ch60s90rjqkmqvgdpq1gbd';
...
export const ENABLED_AUGMENTATION_TYPES = [
  ...
  CONDITION_KEY.ANY_SEARCH_ENGINE,
  CONDITION_KEY.ANY_URL,
